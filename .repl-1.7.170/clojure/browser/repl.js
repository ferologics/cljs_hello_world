...
var seq__4088_4092 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__4089_4093 = null;
var count__4090_4094 = (0);
var i__4091_4095 = (0);
while(true){
if((i__4091_4095 < count__4090_4094)){
var str_4096 = cljs.core._nth.call(null,chunk__4089_4093,i__4091_4095);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),str_4096);

var G__4097 = seq__4088_4092;
var G__4098 = chunk__4089_4093;
var G__4099 = count__4090_4094;
var G__4100 = (i__4091_4095 + (1));
seq__4088_4092 = G__4097;
chunk__4089_4093 = G__4098;
count__4090_4094 = G__4099;
i__4091_4095 = G__4100;
continue;
} else {
var temp__4425__auto___4101 = cljs.core.seq.call(null,seq__4088_4092);
if(temp__4425__auto___4101){
var seq__4088_4102__$1 = temp__4425__auto___4101;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__4088_4102__$1)){
var c__3197__auto___4103 = cljs.core.chunk_first.call(null,seq__4088_4102__$1);
var G__4104 = cljs.core.chunk_rest.call(null,seq__4088_4102__$1);
var G__4105 = c__3197__auto___4103;
var G__4106 = cljs.core.count.call(null,c__3197__auto___4103);
var G__4107 = (0);
seq__4088_4092 = G__4104;
chunk__4089_4093 = G__4105;
count__4090_4094 = G__4106;
i__4091_4095 = G__4107;
continue;
} else {
var str_4108 = cljs.core.first.call(null,seq__4088_4102__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),str_4108);

var G__4109 = cljs.core.next.call(null,seq__4088_4102__$1);
var G__4110 = null;
var G__4111 = (0);
var G__4112 = (0);
seq__4088_4092 = G__4109;
chunk__4089_4093 = G__4110;
count__4090_4094 = G__4111;
i__4091_4095 = G__4112;
continue;
}
} else {
}
...
var args4115 = [];
var len__3340__auto___4118 = arguments.length;
var i__3341__auto___4119 = (0);
while(true){
if((i__3341__auto___4119 < len__3340__auto___4118)){
args4115.push((arguments[i__3341__auto___4119]));

var G__4120 = (i__3341__auto___4119 + (1));
i__3341__auto___4119 = G__4120;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args4115.length)].join('')));
...
var script__$1 = (function (){var G__4125 = script;
goog.object.set(G__4125,"type","text/javascript");

goog.object.set(G__4125,"onload",onload);

goog.object.set(G__4125,"onreadystatechange",onload);

return G__4125;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__4126 = script__$1;
goog.object.set(G__4126,"src",src);

return G__4126;
})():(function (){var G__4127 = script__$1;
goog.dom.setTextContext(G__4127,opt_sourceText);
...
var path_4128 = (goog.dependencies_.nameToPath[src]);
goog.object.remove(goog.dependencies_.visited,path_4128);

goog.object.remove(goog.dependencies_.written,path_4128);

goog.object.remove(goog.dependencies_.written,[cljs.core.str(goog.basePath),cljs.core.str(path_4128)].join(''));
} else {
}
